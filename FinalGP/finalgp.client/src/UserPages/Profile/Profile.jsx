            ...
            {profile && (
                <div className="profile-card">
                    ...
                    <div className="profile-buttons">
                        <button className="button-33-p" onClick={() => navigate(`/EditProfile/${userId}`)}>
                            <MdEdit /> Edit Profile
                        </button>

                        {userRole === "User" && (
                            <button className="button-33-p" onClick={() => navigate(`/user-bookings/${userId}`)}>
                                <MdBook /> My Bookings
                            </button>
                        )}

                        {userRole === "Owner" && (
                            <button className="button-33-p" onClick={() => navigate(`/manage-bookings/${userId}`)}>
